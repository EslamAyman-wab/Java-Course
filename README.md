...
- **B_Ch**: Intermediate challenges organized by topic
  - Ch_12: Bank account operations
  - Ch_13: Customer management
  - Ch_14: Student records
  - Ch_15: Employee management (inheritance with workers and salaried employees)
...
- **B_Ex** (Ex_11 - Ex_20): Intermediate exercises
  - Arrays, loops, and data manipulation
- **C_Ex** (Ex_21 - Ex_29): Object-oriented programming basics
- **D_Ex** (Ex_30+): Advanced exercises with multiple classes
...
#### **D_Test_Area** - Testing & Experimentation
Sandbox area for testing and experimenting with concepts:
- Simple test files (Test_01 - Test_06)
...
- **E_oop**: Object-Oriented Programming deep dives
  - Constructor patterns and practices
...
- Interface-based design (Printer, SmartKitchen)
...
This is a Java IntelliJ IDEA project with the following structure:
...
3. Run individual files using the built-in IDE runner
4. Review the code and implement solutions

---

**Note**: This repository represents a progressive learning journey through Java programming, from basic syntax to object-oriented design principles.
